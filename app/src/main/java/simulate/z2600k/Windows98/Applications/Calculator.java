...
public class Calculator extends Window {
    ...
    public Calculator(){
        super("计算器", getBmp(R.drawable.calculator_1),
        ...
        viewGroup.add(new ButtonInList("标准型"));
        viewGroup.add(new ButtonInList("科学型"));
        ...
        helpTopics.action = parent -> new HelpTopics("计算器帮助", true,
        ...
        ButtonInList about = new ButtonInList("关于计算器");
        about.action = parent -> new AboutWindow(Calculator.this, "计算器", getBmp(R.drawable.calculator_0));
        ...
        // buttons
        addElement(new Button("退格", 63, 29, 57, 78, Color.RED, parent -> {
            if(error)
                return;
