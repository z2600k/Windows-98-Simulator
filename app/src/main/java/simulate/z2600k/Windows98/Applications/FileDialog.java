...
public class FileDialog extends DialogWindow {
    ...
    public FileDialog(boolean open, String[] extensions, String fileDescription, Window parentWindow, OnResultListener onResultListener,
        ...
        super(open? "打开" : "另存为", 443, 413, true, parentWindow);
        backgroundBmp = getBmp(open? R.drawable.open_file_dialog : R.drawable.save_file_dialog);
        defaultButton = new Button(open? "打开" : "保存", new Rect(337, 350, 412, 371), parent -> {
        ...
        addCloseButton(new Rect(337, 377, 412, 398), "取消");
        fillWindow = false;
        ...
        textBox = new TextBox(new Rect(96, 353, 317, 367), 2, 11, p, new Rect(-1, -11, 0, 2));
        ...
        DropdownList fileExtensionsList = new DropdownList(new String[]{fileDescription, "所有文件 (*.*)"}, 0, 225);
        addElement(fileExtensionsList, 94, 375);
        ...
        addElement(folderDropdownList, 103, 28);
    ...
    public static class FolderDropdownList extends DropdownList {
        ...
        private FolderDropdownList(FileDialog fileDialog){
            this(fileDialog.linkContainer, 168,
        ...
        static Link[] getItems(File directory, Bitmap directoryBmp, String directoryString, boolean allowExternalStorageDirectory){
            ...
            Link desktop = Link.createExplorerDropdownLink("桌面", getBmp(R.drawable.desktop_3));
            desktop.path = MyDocuments.getDesktopDirectory();
            links.add(desktop);

            Link myDocs = Link.createExplorerDropdownLink("我的文档", getBmp(R.drawable.directory_open_file_mydocs_2));
