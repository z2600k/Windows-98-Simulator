...
public class MsDos extends BaseNotepad {
    ...
    private SimpleDateFormat timeFormat = new SimpleDateFormat("H:mm:ss:SS", Locale.CHINA);
    {
    ...
    private SimpleDateFormat dateFormat = new SimpleDateFormat("EEE MM-dd-yyyy", Locale.CHINA);

    private static final String initialText = "\n\nMicrosoft(R) Windows 98\n   (C)Copyright Microsoft Corp 1981-1999.";
    private static final String driveLabel = "\n Volume in drive C has no label\n Volume Serial Number is 1662-1510";
    ...
    public MsDos(){
        this(new Rect(5, 52, 598 - 6, 272 - 6),
            ...
            if(lastCommand.isEmpty()){
                ...
                if(command.equals("ver")){
                    ...
                    for(Element element : explorer.linkContainer.elements){
                        ...
                        print(String.format("%s %-3.3s   %s    05-05-99 22:22 %s",
                    ...
                    print("----------------  --------   --------   --------");
                    print("Conventional          636K        48K       589K");
                    print("Upper                   0K         0K         0K");
                    print("Reserved                0K         0K         0K");
                    print("Extended (XMS)     65,472K          ?   129,800K");
                    print("----------------  --------   --------   --------");
                    print("Total memory       66,108K          ?   130,397K\n");
                    print("Total under 1 MB      636K        48K       589K\n");
                    print("Total Expanded (EMS)                   64M (66,600,960 bytes)");
                    print("Free Expanded (EMS)                    16M (16,777,216 bytes)\n");
                    print("Largest executable program size       588K (602,608 bytes)");
